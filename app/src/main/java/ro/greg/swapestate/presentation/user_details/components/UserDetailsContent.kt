...
import ro.greg.shtistorm.presentation.auth.components.TextFieldState
...
import ro.greg.swapestate.presentation.components.ProfileImage
        ...
        Column(
            ...
            Row(
                ...
                Row(
                    ...
                    RadioButton(selected = selected == "Renter", onClick = { selected = "Renter" })
                    Text(
                        text = "Renter",
                        modifier = Modifier.clickable(onClick = { selected = "Renter" }).padding(vertical = 8.dp)
                    )
                }
                Row(
                    Modifier.padding(horizontal = 30.dp),
                    ...
                    RadioButton(selected = selected == "Owner", onClick = { selected = "Owner" })
                    Text(
                        text = "Owner",
                        modifier = Modifier.clickable(onClick = { selected = "Owner" }).padding(vertical = 8.dp)
                    )
